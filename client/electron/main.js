...
function createMainWindow() {
  ...
  // Безопасность: блокируем DevTools в production (временно отключено для дебага)
  // TODO: вернуть после отладки чёрного экрана
  // if (!isDev) {
  ...
  //   });
  // }
  // Автоматически открыть DevTools для диагностики
