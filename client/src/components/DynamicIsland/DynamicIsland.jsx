...
import {
  ...
  User, BellSlash, EyeSlash, GearSix, SignOut,
...
export default function DynamicIsland({ islandState, user, onAcceptCall, onDeclineCall, onEndCall, onOpenChat, onOpenProfile, onOpenSettings, onLogout }) {
  const {
            ...
            <motion.div key="profile" className="di__inner di__inner--profile" initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: 4 }} transition={{ duration: 0.25 }}>
              <div className="di__prof-head">
                ...
                <div className="di__prof-info">
                  ...
                  <span className="di__prof-status">в сети</span>
                </div>
              ...
              <div className="di__prof-grid">
                ...
                <button className="di__prof-btn" onClick={e => e.stopPropagation()}><BellSlash size={18} /><span>DND</span></button>
                <button className="di__prof-btn" onClick={e => e.stopPropagation()}><EyeSlash size={18} /><span>Невидимка</span></button>
