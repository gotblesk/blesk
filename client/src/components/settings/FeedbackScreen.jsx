...
import { Bug, Lightbulb, Question, FileText, CheckCircle, X } from '@phosphor-icons/react';
...
const TYPES = [
  { id: 'bug', emoji: <Bug size={16} weight="regular" />, label: 'Баг' },
  { id: 'suggestion', emoji: <Lightbulb size={16} weight="regular" />, label: 'Предложение' },
  { id: 'question', emoji: <Question size={16} weight="regular" />, label: 'Вопрос' },
];
        ...
        {!sent ? (
          <>
            <div className="feedback-header">
              <div className="feedback-header__icon"><FileText size={18} weight="regular" /></div>
                    ...
                    return (
                      <div key={fb.id} className="feedback-history__item">
                        <div className="feedback-history__type">
                          {typeInfo ? typeInfo.emoji : <FileText size={16} weight="regular" />}{' '}
          ...
          <div className="feedback-success">
            <div className="feedback-success__icon"><CheckCircle size={32} weight="regular" /></div>
